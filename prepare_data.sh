...
# ori -> raw.
# Train data.
python3 -u $m2_to_parallel "$ORI/fce/fce/m2/fce.train.gold.bea19.m2" "$RAW/fce-train.src" "$RAW/fce-train.trg" 0
python3 -u $m2_to_parallel "$ORI/nucle/release3.3/bea2019/nucle.train.gold.bea19.m2" "$RAW/nucle.src" "$RAW/nucle.trg" 0
python3 -u $m2_to_parallel "$ORI/lang8/lang8.train.auto.bea19.m2" "$RAW/lang8.src" "$RAW/lang8.trg" 0
python3 -u $m2_to_parallel "$ORI/wi_locness/wi+locness/m2/ABC.train.gold.bea19.m2" "$RAW/wi_locness-train.src" "$RAW/wi_locness-train.trg" 0
# Valid data.
